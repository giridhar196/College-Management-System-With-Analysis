...
$mess='';
$i=0;
$sqlc = "SELECT COUNT(id) as coun FROM `used_store` WHERE branch = '$B_R_A_N_C_H' AND quantity !='0' AND sold !='1' AND permission != '0'";
...
$sql = "SELECT * FROM `used_store` WHERE branch = '$B_R_A_N_C_H' AND quantity !='0' AND permission != '0' AND sold !='1'";
                ...
                <div class="bg-image" style="background-image: url('assets/img/photos/photo26@2x.jpg');">
                    <div class="bg-black-op-75">
                        <div class="content content-top content-full text-center">
                            <div class="py-20">
                                <h1 class="h2 font-w700 text-white mb-10">Used Store</h1>
                                <h2 class="h4 font-w400 text-white-op mb-0">Products processing</h2>
                            </div>
                        </div>
                    </div>
                </div>
