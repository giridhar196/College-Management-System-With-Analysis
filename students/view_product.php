...
if (mysqli_num_rows($run_sql) > 0) {
    while($row = mysqli_fetch_assoc($run_sql)) {
      ...
      $per=$row["permission"];
    //   $maillink="email_order.php?id=$sno&name=giri&pn=book&cost=50&by=giridhar";
    }
}
}
...
$htmlContent = file_get_contents("email_order.php");
                    ...
                    <div class="bg-primary-dark-op">
                        <div class="content content-top text-center overflow-hidden">
                            <div class="pt-50 pb-20">
                                <h1 class="font-w700 text-white mb-10 invisible" data-toggle="appear" data-class="animated fadeInUp">View Product</h1>
