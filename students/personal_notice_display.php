...
<?php 
$i=0;
$sql_count = "SELECT COUNT(id) as count FROM `notice_board` WHERE regdno='$R_E_I_D'";
 ...
 $sql_stud = "SELECT * FROM `notice_board` WHERE regdno='$R_E_I_D' ORDER BY id DESC";
            ...
            <main id="main-container">
                ...
                <div class="bg-image" style="background-image: url('assets/img/photos/photo26@2x.jpg');">
                    <div class="bg-black-op-75">
                        <div class="content content-top content-full text-center">
                            <div class="py-20">
                                <h1 class="h2 font-w700 text-white mb-10">Personal Notice Board</h1>
                ...
                <div class="content">
                    <nav class="breadcrumb bg-white push">
                        <a class="breadcrumb-item" href="#">Personal Notice</a>
                        <span class="breadcrumb-item active">Notice Board</span>
                    </nav>
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Personal Notice Board</h3>
