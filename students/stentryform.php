            ...
            <main id="main-container">
                    ...
                    <div class="bg-primary-dark-op">
                        <div class="content content-top text-center overflow-hidden">
                            <div class="pt-50 pb-20">
                                <h1 class="font-w700 text-white mb-10 invisible" data-toggle="appear" data-class="animated fadeInUp">Entry Form</h1>
                                <h2 class="h4 font-w400 text-white-op invisible" data-toggle="appear" data-class="animated fadeInUp">Welcome to Student Entry panel!</h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="content">
                    ...
                    <div class="block-header bg-info">
                            <h3 class="block-title">Stay Educated Before Entering Please Make Correct details</h3>
                                ...
                                <div class="col-xl-6">
                                   ...
                                   <p> <?php echo $msg;?></p>
                                                <div class="form-material">
                                                    ...
                                                    <label for="val-reg-no">Admission Number: If No Original Please enter any other</label>
                                                </div>
                                            </div>   
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-6">
                                            <div class="form-material">
                                                <input type="text" class="form-control" id="val-rank" name="val-rank" placeholder="Eamcet rank ">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="form-group">
                                                                                <div class="form-material">
                                                                                    <input type="text" autocomplete="off" class="form-control" id="val-nati" name="val-nati" placeholder="Annual Income Of the Family">
