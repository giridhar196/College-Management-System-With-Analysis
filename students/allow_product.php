...
<?php
$sqlcp = "SELECT * FROM `radius` WHERE auth_id='$au_num' AND store='1'";
...
$i=0;
$msg='';
$sqlc = "SELECT COUNT(id) as coun FROM `used_store` WHERE branch='$B_R_A_N_C_H'";
...
$sql = "SELECT * FROM `used_store` WHERE branch='$B_R_A_N_C_H'";
            ...
            <div class="bg-image" style="background-image: url('assets/img/photos/photo26@2x.jpg');">
                <div class="bg-black-op-75">
                    <div class="content content-top content-full text-center">
                        <div class="py-20">
                            <h1 class="h2 font-w700 text-white mb-10">Allow / Block Products</h1>
            ...
            <div class="bg-body-light border-b">
                <div class="content py-5 text-center">
                    <nav class="breadcrumb bg-body-light mb-0">
                        <a class="breadcrumb-item" href="be_pages_ecom_dashboard.html">Used Store</a>
                ...
                <div class="block">
                    ...
                    <div class="table-responsive">
                        <div class="block-content block-content-full">
                            ...
                            <form action="allow_productsubmit" method="post">
