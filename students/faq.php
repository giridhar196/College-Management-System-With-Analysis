                ...
                <div class="block">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="js-wizard-validation-material block">
                            ...
                            <!-- Form -->
                            <form class="js-wizard-validation-material-form" action="faqsub.php" method="post">
                                <!-- Steps Content -->
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        ...
                                                        <p>
                                                            ...
                                                            through the Service.  is not responsible for any damages,
                                                            injury or economic loss arising from the use of the content or
                                                            Service provided by .
                                                        </p>
                                                        <p>
                                                            In no event will  be liable to you for any direct, indirect, incidental or consequential damages or economic loss
                                                            arising out of the Service or in connection with your website
                                                            or any other services or products provided to you.
                                                        </p>
                                                        <p>
                                                            , its officers, directors, owners, agents and employees shall in no way be liable to you or anyone else for any
                                                            loss or injury resulting from the use of the Service or of your
                                                            website.
                                                        </p>
                                                        <p>
                                                            In no event shall  be held liable for any damages or economic loss, whatsoever, as a result of notifying any official
                                                    ...
                                                    <li>
                                                        ...
                                                        <p>
                                                            You agree to indemnify and hold , its affiliates, sponsors, partners, directors, officers and employees harmless
                                                            from and against, and to reimburse  with respect to,
                                                    ...
                                                    <li>
                                                        ...
                                                        <p>
                                                             will not be liable for any delay, interruption or failure in the provisioning of services if caused by acts of
                                                    ...
                                                    <li>
                                                        ...
                                                        <p>
                                                             does not accept agreements and payments from persons under the legal age of 18 years. By submitting your account
                                                    ...
                                                    <li>
                                                        <h2>10. Email</h2>
                                                        <p>
                                                            email service provides customers with the capability to send and receive email via the Internet. 
                                                        ...
                                                        <p>
                                                            As an owner and operator of the equipment and other resources utilized to provide services,  has the legal right
                                                            to block electronic communications from other entities on the
                                                            Internet.
                                                        </p>
                                                        <p>
                                                             relies on the support of its sponsors and advertisers to help offset the cost of the Services offered to its
                                                            Subscribers. You acknowledge that as part of your 
                                                            Service, advertisement sponsored email newsletters may be sent
                                                            to Subscribers and  email service email accounts.
                                                        </p>
                                                    </li>
                                                    <li>
