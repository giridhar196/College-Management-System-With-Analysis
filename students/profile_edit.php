                        ...
                        <div class="col-md-7">
                            <div class="form-group row">
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control form-control-lg" id="mega-bio" name="mega-bio" value="<?php echo $achivements?>" rows="26"
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control form-control-lg" value="<?php echo $vision ?>" id="mega-vision" name="mega-vision"
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control form-control-lg" value="<?php echo $strength ?>" id="mega-strength" name="mega-strength"
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control form-control-lg" value="<?php echo $hobiees ?>" id="mega-hobiee" name="mega-hobiee"
                                        placeholder="Enter your Strength..">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control form-control-lg" id="mega-role" value="<?php echo $rolemodal  ?>" name="mega-role"
