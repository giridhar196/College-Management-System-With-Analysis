                    ...
                    <div class="bg-pattern bg-black-op-25" style="background-image: url('assets/img/various/bg-pattern.png');">
                        <div class="content text-center">
                            <div class="pt-50 pb-20">
                                <h1 class="font-w700 text-white mb-10">Chatting Panel</h1>
                                <h2 class="h4 font-w400 text-white-op">It's your own chatting application!</h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="tab-pane fade fade-left" id="chat-people" role="tabpanel">
                        <div class="js-chat-people block-content block-content-full overflow-y-auto bg-pattern" style="background-image: url('assets/img/various/bg-pattern-inverse.png');">
                            <div class="row mb-0">
                                ...
                                <div class="col-md-4">
                                    <h3 class="h1 font-w300 text-warning">Offline</h3>
                                    <ul class="nav-users mt-10 push">
                                        <div class="display-awake" id="display-awake"></div>
                                    </ul>
                                </div>
                                <div class="col-md-4">
                                    <h3 class="h1 font-w300 text-muted">Teachers</h3>
                                    <ul class="nav-users mt-10 push">
                                        <div class="display-teachers" id="display-teachers"></div>
                                    </ul>
                                </div>
                            </div>
                        </div>
