...
echo $userData['first_name'];
    $query = "INSERT INTO blog SET auth = '".$userData['oauth_uid']."', p_by='".$userData['first_name']."', p_email = '".$userData['email']."',  dateofpost = '".date("Y-m-d")."', created = '".date("Y-m-d H:i:s")."',regid='$R_E_I_D',title='$p_na',category='$p_cat',description='$p_des',visible='$p_vis',short_desciption='$p_shot',header_link='$p_link',permission='0'";
        ...
        <div class="content content-top content-full text-center">
            <div class="py-20">
                ...
                <h2 class="h4 font-w400 text-white-op mb-0">In
                    <a class="text-primary-light link-effect" href="be_pages_ecom_products.html">Blog</a> Creation.</h2>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="bg-body-light border-b">
                    <div class="content py-5 text-center">
                        <nav class="breadcrumb bg-body-light mb-0">
                            <a class="breadcrumb-item" href="be_pages_ecom_dashboard.html">e-Blog</a>
                            <a class="breadcrumb-item" href="be_pages_ecom_products.html">New Blog</a>
                                ...
                                <div class="block block-rounded block-themed">
                                    ...
                                    <div class="block-content block-content-full">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <select class="js-select2 form-control" id="example-visible" name="example-visible" style="width: 100%;" data-placeholder="Choose one..">
                                                    <option></option><!-- Required for data-placeholder attribute to work with Select2 plugin -->
                                                    <option value="<?php echo $B_R_A_N_C_H; ?>" >Only For <?php echo $B_R_A_N_C_H; ?></option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                <textarea class="form-control" id="ecom-product-description-short" name="ecom-product-description-short" placeholder="Description visible on preview.." rows="6"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text" class="js-tags-input form-control" data-height="34px" id="ecom-product-meta-tags" name="ecom-product-meta-tags" placeholder="Meta Tags">
