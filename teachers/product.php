...
$i=0;
$msg='';
$sqlc = "SELECT COUNT(id) as coun FROM `used_store` WHERE auth = '".$userData['oauth_uid']."'";
...
$sql = "SELECT * FROM `used_store` WHERE auth = '".$userData['oauth_uid']."'";
    ...
    <main id="main-container">
        ...
        <div class="bg-body-light border-b">
            <div class="content py-5 text-center">
                <nav class="breadcrumb bg-body-light mb-0">
                    <a class="breadcrumb-item" href="#">Used Store</a>
        ...
        <div class="content">
            ...
            <div class="row gutters-tiny">
                ...
                <!-- Add Product -->
                <div class="col-md-6 col-xl-6">
                    <a class="block block-rounded block-link-shadow" href="product_edit">
                        <div class="block-content block-content-full block-sticky-options">
                            <div class="block-options">
                                <div class="block-options-item">
                        ...
                        <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                            <thead>
                                <tr>
                                    ...
                                    <th>Status</th>
                                    <th class="d-none d-sm-table-cell">Submited</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="submit" name="edit" id="edit" class="btn btn-sm btn-secondary" value="<?php echo $snoa[$pt]; ?>" data-toggle="tooltip"
                                            title="Edit Product">
                                            <i class="fa fa-edit"></i>
                                        </button>
                                        <button type="submit" class="btn btn-sm btn-secondary" name="delete" id="delete"  value="<?php echo $snoa[$pt]; ?>" data-toggle="tooltip" title="Delete">
