    ...
    var initWizardValidation = function () {
        ...
        var validatorMaterial = formMaterial.validate({
            ...
            rules: {
                ...
                'example-masked2-date1': {
                    required: true
                },
                'wizard-validation-material-branch': {
                    required: true
                },
                'wizard-validation-material-blood':{
                    required: true
                },
                'wizard-validation-material-regdno':{
                    required: true,
                    minlength: 10
                },
            ...
            messages: {
                ...
                'wizard-validation-material-regdno':{
                    ...
                    minlength: 'Your Roll Number Should Contain 10 Characters'
                },
                'wizard-validation-material-blood':{
                    required: 'Incase Any one Need Blood We Give a quick Report Please Enter'
                },
                'example-masked2-phone': {
                ...
                'wizard-validation-material-email': 'Please enter a valid  address',
