...
<script>
    ...
    function category(c_id) {
        $(".display-category").load("edit_display_category?ca_id="+c_id);
    }
...
$i=0;
$msg='';
$sqlc = "SELECT COUNT(id) as coun FROM `tblcategory`";
...
if(isset($_GET['submit'])){
    ...
    $update_user_profile = "UPDATE tblcategory SET CategoryName='$name_category' WHERE id='$snos'";
