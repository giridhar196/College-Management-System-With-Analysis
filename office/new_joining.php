<?php
    ...
    $sql = "SELECT * FROM `admission_fee_details` WHERE type_name='$adm_category'";
    $run_sql=mysqli_query($conn,$sql);
    if (mysqli_num_rows($run_sql) > 0) {
...
if ($conn->query($sql) === TRUE) {
    $msg="Sucessfully Your Data is Uploaded";
    $butt="js-notify btn btn-lg btn-block btn-alt-primary";
    include "mail.php";
} else {
